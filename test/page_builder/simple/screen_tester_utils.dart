...
extension ScreenSizeManager on WidgetTester {
  ...
  Future<void> setWeb1920() => this._setScreenSize(width: 1920, height: 1200, pixelDensity: 3);

  Future<void> setWeb1280() => this._setScreenSize(width: 1280, height: 1024, pixelDensity: 3);

  Future<void> setTablet() => this._setScreenSize(width: 750, height: 400, pixelDensity: 3);
}
